...
public class QuizActivity extends AppCompatActivity {
    public static final String EXTRA_SCORE = QuizActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        textViewQuestionCount = findViewById(R.id.tv_qustions_count);
        textViewCountDown = findViewById(R.id.tv_countdown);
        rbGroup = findViewById(R.id.radio_group);
        rb1 = findViewById(R.id.rb_button1);
        rb2 = findViewById(R.id.rb_button2);
        rb3 = findViewById(R.id.rb_button3);
